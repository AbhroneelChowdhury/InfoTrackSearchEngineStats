...
{
    public class BingSearchStatsTest
    {
        ...
        [TestCase("infotrack.com.au", 28)]
        [TestCase("infotrackgo.com.au", 1)]
        public void BingSearchResultsMustMatchStaticSearch(string searchAddr, int searchPosition)
        {
            Runner.Scenario()
                .Given($"Search String - Online Title Search and a search address - {searchAddr}", () =>
                    new
                    {
                ...
                .When($"{nameof(ISearchService.PerformBingSearch)} is called", context =>
                {
                    var searchService = ServiceProvider.GetRequiredService<ISearchService>();
                    return searchService.PerformBingSearch(new GetSearchResultsQuery(SearchEngine.Bing,
        ...
        [Test]
        public void BingSearchResultsMustReturnEmpty()
        {
            Runner.Scenario()
